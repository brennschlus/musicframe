...
static void frame_select_render_top(AppState* self, AppContext* ctx, C3D_RenderTarget* target)
{
    (void)self;
...
AppState* state_frame_select_create(void)
{
    return &s_frame_select;
}
