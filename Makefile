...
# Project settings
#---------------------------------------------------------------------------------
APP_TITLE       := Music Photo Frame
APP_DESCRIPTION := Atmospheric photo frame with music playback
APP_AUTHOR      := musicframe

TARGET          := musicframe
BUILD           := build
SOURCES         := source source/state source/states source/image source/scene source/audio source/fs source/camera source/ui source/net
DATA            := data
INCLUDES        := include
GRAPHICS        := gfx
#ROMFS          := romfs
